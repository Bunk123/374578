------ * serotonin priv_9 Menu * ------
--[[
    # Rewriten by: serotonin_prod
]]
...
repeat
 ...
 -- Menu/UI Creation
 if not isfile("jailbreak.prod") then
    makefolder("jailbreak.prod")
 end
 
 local menu = game:GetObjects("rbxassetid://17831641147")[1] 
 ...
 local function createWatermark()
    ...
    task.spawn(function()
       while task.wait() do
         ...
         WaterMarkLabel.Text = 'serotonin.<font color="rgb(229, 215, 215)">prod</font> - uid: <font color="rgb(229, 215, 215)">' .. uid .. '</font> / fps: <font color="rgb(229, 215, 215)">' .. fpsValue .. '</font> / ping: <font color="rgb(229, 215, 215)">' .. ping .. '</font> / time: <font color="rgb(229, 215, 215)">' .. time .. '</font>'
       end
    end)
    return Watermark
 end
 ...
 local library = {
    Title = 'jailbreak.<font color="rgb(107, 100, 100)">prod</font>',
        ...
        function library:Notify(Text, Time)
            ...
            draggable(menu.bg)
                ...
                function library:Tween(...) TweenService:Create(...):Play() end
                    function library:addTab(name,image)
                        ...
                        for _, v in pairs(list) do
                            ...
                            writefile("jailbreak.prod/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
                ...
                function library:refreshConfigs()
                    local tbl = {}
                    for i,v in next, listfiles("jailbreak.prod") do table.insert(tbl,v) end
